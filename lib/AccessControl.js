 ...
 */
module.exports.parseAuthorization = function(val){
	val = val.split(" ");
 ...
 */
module.exports.hasToken = headers => {
...
module.exports.handler = $ => {
	...
	if(this.hasToken($.headers)){
		var authorization = this.parseAuthorization($.headers["authorization"]);

		var session = this.getSession(authorization.credentials);
